...
function HomePro(props) {
    return (
        <>
            <Row justify='center' align='middle' className='home-pro-section'>
                <div className='video-home-pro video-module'>
                    <video preload='true' muted loop autoPlay >
                        <source src='https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltcdddb048cf8e1969/61dbf052bf9cb8387cc1db29/HEADER_Neon_Desktop.mp4' type='video/mp4' />
                    </video>
                </div>

                <div className='section-wrapper'>
                    <div className='content-home-pro'>
                        <div className='view-home-pro icon'>
                            <p className='text-p-home-pro text-style'>
                                Một tựa game bắn súng chiến thuật 5 đấu 5 lấy các nhân vật làm nền tảng
                            </p>
                            <svg viewBox="0 0 690 98.9" className='logo-valorant'>
